...
class PersonalEventForm(ModelForm):
    ...
    mulai = forms.DateTimeField(
        widget=forms.DateInput(
            attrs={'class': 'datepicker-here', 'data-timepicker':'true', 'placeholder': '2020-01-30 01:00', 'data-language': "en"}),
        
    )

    selesai = forms.DateTimeField(
        widget=forms.DateInput(
             attrs={'class': 'datepicker-here', 'data-timepicker':'true', 'placeholder': '2020-12-31 23:59', 'data-language': "en"}),
